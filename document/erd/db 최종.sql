...
INSERT INTO prod_color_tb (color_name, color_code) VALUES
('블랙', '#000000'),
('화이트', '#FFFFFF'),
('레드', '#FF0000'),
('블루', '#0000FF'),
...
-- blouse-shirts
('썸머 프릴 데일리 블라우스', 45000, NOW(), 1, 0, 1),
('기본 포켓 긴팔 셔츠', 29900, NOW(), 1, 0, 2),
('코튼 스프라이트 셔츠', 21900, NOW(), 1, 0, 2),
('꾸안꾸 데일리 셔츠', 49900, NOW(), 1, 0, 2),
('허리잘록핏 반팔 셔츠', 29900, NOW(), 1, 0, 2),
